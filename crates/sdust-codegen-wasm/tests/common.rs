...
use sdust_sir::sir::{
    ...
    Program, SirFnId, SirTy, Term, VariantRef,
};
...
pub fn program_with_adts_and_fn() -> Program {
    ...
    let mut add = Function {
        id: SirFnId(1),
        name: "add".into(),
        params: vec![sdust_sir::sir::Local(1), sdust_sir::sir::Local(2)],
        locals: vec![
            LocalDecl {
                name: "_0".into(),
                ty: SirTy::Int(IntKind::I32),
    ...
    add.params = vec![sdust_sir::sir::Local(1), sdust_sir::sir::Local(2)];
    p.fns.push(add);
