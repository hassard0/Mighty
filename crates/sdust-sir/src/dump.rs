...
pub fn dump_program(p: &Program) -> String {
    ...
    out.push_str("// Stardust IR (SIR) v0.6\n");
...
pub fn dump_ty(t: &SirTy) -> String {
    match t {
        SirTy::Bool => "Bool".into(),
        SirTy::Int(k) => format!("{:?}", k),
        SirTy::Float(k) => format!("{:?}", k),
        SirTy::Char => "Char".into(),
        SirTy::Str => "Str".into(),
        SirTy::String => "String".into(),
        SirTy::Bytes => "Bytes".into(),
        SirTy::Unit => "Unit".into(),
        SirTy::Never => "Never".into(),
        ...
        SirTy::Dyn(n) => format!("dyn {}", n),
        SirTy::RawPtr(inner) => format!("*{}", dump_ty(inner)),
        SirTy::Module(n) => format!("module {}", n),
        SirTy::Param(n) => n.clone(),
...
mod tests {
    ...
    fn empty_program_dumps_header() {
        ...
        assert!(s.contains("Stardust IR (SIR) v0.6"));
    }
