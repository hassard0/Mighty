...
pub const STDLIB_EXAMPLES: &[StdlibExample] = &[
    ...
    StdlibExample {
        ...
        description: "`true→1`, `false→0`. The only widening allowed for `Bool`; all other `Bool as Ty` casts emit MT2027.",
        capability: "",
        example: "let flag: Bool = true;\nlet n: U8 = flag as U8;\nassert_eq(n, 1);\n",
        see_also: "cast_as, cast_invalid_mt2027",
    },
    StdlibExample {
        ...
        see_also: "cast_as, String.chars",
    },
    StdlibExample {
        symbol: "cast_ptr_to_usize",
        signature: "*Ty as USize",
        description: "Reinterpret a raw pointer as a platform-sized integer. The reverse (`USize as *Ty`) also works and is the canonical way to round-trip handles through C-ABI integer slots.",
        capability: "",
        example: "let p: *U8 = \"hi\".as_ptr();\nlet addr: USize = p as USize;\nlog(format!(\"addr={}\", addr));\n",
        see_also: "cast_as, cast_usize_to_u64, addr_of_local",
    },
    StdlibExample {
