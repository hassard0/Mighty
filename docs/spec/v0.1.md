...
compatibility — see [`examples/19_backend_service.mty`](https://github.com/hassard0/Mighty/blob/main/examples/19_backend_service.mty)
and [`examples/20_frontend_component.mty`](https://github.com/hassard0/Mighty/blob/main/examples/20_frontend_component.mty).
The full list is in [SLICE1.md](https://github.com/hassard0/Mighty/blob/main/SLICE1.md).
