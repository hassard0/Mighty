# Stardust Language Specification v0.1

The full specification is maintained outside the repository at
`stardust_language_spec_v0_1.md`. A copy lives in the project owner's
...
- the compilation pipeline (HIR, AIR, SIR);
...
|---|---|
| §4 Program structure | [01 — Hello, Stardust](../tour/01-hello.md) |
...
compatibility — see [`examples/19_backend_service.sd`](../../examples/19_backend_service.sd)
and [`examples/20_frontend_component.sd`](../../examples/20_frontend_component.sd).
