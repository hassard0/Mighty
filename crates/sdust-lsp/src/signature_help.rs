...
use rowan::TextSize;
use sdust_syntax::{SyntaxElement, SyntaxKind, SyntaxNode, SyntaxToken};
use sdust_types::{pretty_ty, DefRef, FnDef};
...
fn render_fn_signature(
    f: &FnDef,
    arena: &sdust_types::TyArena,
    defs: &sdust_types::DefMap,
    active_param: u32,
) -> SignatureHelp {
