...
use crate::ir::*;
use mty_types::{AdtId, CapConstraint, CapFamily, FloatKind, IntKind};
...
impl Frame {
    pub fn new(fn_id: IrFnId, locals: Vec<Value>, scope: ScopeId, entry: BlockId) -> Self {
        Self {
            fn_id,
            locals,
            scope,
