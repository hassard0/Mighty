...
`crates/sdust-runtime/tests/mailbox_slab_pool.rs::slab_reuse_preserves_fifo_for_many_messages`
for the bound-down version).

The conformance harness drives this through the SIR interp, which
