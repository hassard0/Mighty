//! Conversion helpers between Stardust diagnostic / span types and the
...
/// Map a Stardust [`Severity`] onto the LSP severity enum. We collapse
...
/// Convert a single [`sdust_diagnostics::Diagnostic`] to its LSP form.
///
...
pub fn diagnostic_to_lsp(
    d: &sdust_diagnostics::Diagnostic,
