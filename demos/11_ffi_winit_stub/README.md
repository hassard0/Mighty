# Demo 11 — FFI scaffold (v0.36 Track T2)

Minimal end-to-end Mighty + C scaffold demonstrating the v0.36 first-class
...
- `src/main.mty` — calls four no-op extern C entry points.
...
known-good on v0.36 and the v0.37 follow-ups (Str→*U8 coercion,
struct-by-value at FFI boundaries, variadics).
