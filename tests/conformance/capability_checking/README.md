...
The capability subsumption check (MT4010) only fires when a callee
...
Consequence: MT4010 cannot be triggered from source today. We
...
- `02_cap_narrow_fs_ro` — positive: caller narrows `fs` via `fs.ro("/data")`, binds locally, no MT4010.
