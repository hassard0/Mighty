...
impl<'a> Emitter<'a> {
    ...
    fn declare_imports(&mut self) -> CompileResult<()> {
        ...
        // The canonical module name (`stardust:web/dom`) matches the
        ...
        if matches!(self.target, WasmTarget::Web) {
            ...
            self.import_section
                .import("stardust:web/dom", "set-text", EntityType::Function(ty));
            ...
            self.import_section
                .import("stardust:web/dom", "get-text", EntityType::Function(ty));
            ...
            self.import_section
                .import("stardust:web/dom", "on-click", EntityType::Function(ty));
            ...
            self.import_section
                .import("stardust:web/dom", "query", EntityType::Function(ty));
