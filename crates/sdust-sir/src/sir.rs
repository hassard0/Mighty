...
use sdust_hir::{FnId, SourceSpan};
use sdust_types::{AdtId, CapConstraint, CapFamily, EffectId, FloatKind, IntKind};

// ----- ID newtypes ---------------------------------------------------------

#[derive(Debug, Clone, Copy, PartialEq, Eq, Hash, PartialOrd, Ord)]
pub struct SirFnId(pub u32);
...
pub struct Agent {
    ...
    pub handlers: Vec<(String, SirFnId)>,
    pub span: SourceSpan,
}
...
impl Program {
    ...
    pub fn fn_by_id(&self, id: SirFnId) -> &Function {
        &self.fns[id.0 as usize]
    }
    pub fn agent_by_id(&self, id: AgentSirId) -> &Agent {
