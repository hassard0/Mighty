...
exceeding a cap traps with SD5009 (budget_exceeded) or SD5012
(mailbox_full).
...
- `02_step_budget_exceeded` — main computes deeply enough to trip the interp's step budget → exit 3 (SD5009).
